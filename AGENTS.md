...
EGL/GLES 原生渲染；输入经 Node-API 桥接转发。
...
| `entry/src/main/ets/pages/SettingsPage.ets` | 全局设置（工具栏触发/隐藏延迟） |
| `entry/src/main/ets/services/CredentialStore.ets` | 基于 ASSET 的凭证存储 |
| `entry/src/main/ets/services/SettingsStore.ets` | 基于 preferences 的设置存储 |
