...
$cfg = @(
  ...
  # code, so the correctness criterion is a *measured* one: the reference run
  # reports the pixel-level numbers (rgbPx/maxDelta), and the difference has to
  # stay at rounding magnitude (doc_agent/gfx-engine.md §8.1/§8.2).
